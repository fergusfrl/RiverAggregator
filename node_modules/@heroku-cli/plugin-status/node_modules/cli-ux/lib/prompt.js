...
function _prompt(name, inputOptions = {}) {
    let prompt = chalk_1.default.dim('> ');
    if (name && inputOptions.default)
        prompt = chalk_1.default.dim(name) + ' ' + chalk_1.default.yellow('[' + inputOptions.default + ']') + chalk_1.default.dim(': ');
    else if (name)
        prompt = chalk_1.default.dim(`${name}: `);
